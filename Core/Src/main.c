...
int main(void)
{
  ...
  blink_ledHandle = osThreadNew(Blink, NULL, &blink_led_attributes);
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOA, LED_Pin|FM_CS_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(TFT_D_C_GPIO_Port, TFT_D_C_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, TFT_BLK_Pin|TFT_CS_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : TFT_D_C_Pin */
  ...
  /*Configure GPIO pins : TFT_BLK_Pin TFT_CS_Pin */
  GPIO_InitStruct.Pin = TFT_BLK_Pin|TFT_CS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
